...
class __TwigTemplate_a6da34118bc99bf3a02b168f36bfab8e2f7201434dde7f48553239927035b9fb extends Template
{
    private $source;
    private $macros = [];
...
$context["log"], "type", [], "any", false, false, false, 142))) ? ("silenced") : (""))))));
                ...
                echo "
                            ...
                            ";
                // line 150
                if ((twig_in_filter(twig_get_attribute($this->env, $this->source, $context["log"], "type", [], "any", false, false, false, 150), ["error", "deprecation", "silenced"]) || ("WARNING" == twig_get_attribute($this->env, $this->source, $context["log"], "priorityName", [], "any", false, false, false, 150)))) {
                    // line 151
...
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "C:\\Users\\elect\\OneDrive\\Desktop\\BE19_CR6_bigEventsAdamAli\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\logger.html.twig");
    }
}
