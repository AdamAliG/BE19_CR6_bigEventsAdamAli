...
class __TwigTemplate_33d9331bb163463cc5d4bc64e98f3f3f4229fa2777041e06c6a95bb19fbfb790 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["attribute"]) || array_key_exists("attribute", $context) ? $context["attribute"] : (function () { throw new RuntimeError('Variable "attribute" does not exist.', 373, $this->source); })()), "type", [], "any", false, false, false, 373) == "string")) {
                    ...
                    echo "                                        </td>
                                        <td>";
                    // line 382
                    echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, $context["decision"], "seek", ["object"], "method", false, false, false, 382));
                    echo "</td>
                                    </tr>
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "C:\\Users\\elect\\OneDrive\\Desktop\\BE19_CR6_bigEventsAdamAli\\vendor\\symfony\\security-bundle\\Resources\\views\\Collector\\security.html.twig");
    }
}
