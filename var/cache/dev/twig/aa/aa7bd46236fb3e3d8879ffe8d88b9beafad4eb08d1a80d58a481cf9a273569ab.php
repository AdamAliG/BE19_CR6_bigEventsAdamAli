...
class __TwigTemplate_0fe55b0c3c56276767dca701e3a3ddf19ce1ab9150204901c44ccc7225b59821 extends Template
{
    private $source;
    private $macros = [];
            ...
            if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["call"], "violations", [], "any", false, false, false, 75))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["violation"]) {
                    ...
                    echo "</td>
                            <td>";
                    // line 89
                    echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, $context["violation"], "seek", ["invalidValue"], "method", false, false, false, 89));
                    echo "</td>
                            <td>";
                    // line 90
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/validator.html.twig", "C:\\Users\\elect\\OneDrive\\Desktop\\BE19_CR6_bigEventsAdamAli\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\validator.html.twig");
    }
}
